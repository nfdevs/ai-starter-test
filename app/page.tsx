...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#fafafa] text-[#1a1a1a]">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-[#4a90e2] focus:text-white focus:rounded focus:outline-none focus:ring-2 focus:ring-[#4a90e2] focus:ring-offset-2 focus:shadow-lg"
      >
        Skip to main content
      </a>
      {/* Hero Section */}
      <section aria-label="Hero section" className="relative mx-auto max-w-6xl px-4 pt-20 pb-16 sm:px-6 sm:pt-32 sm:pb-24 lg:px-8">
        ...
        <div className="mt-16 mx-auto max-w-2xl" role="img" aria-label="Example conversation preview showing AI coach asking about daily priorities">
          <div className="rounded-2xl bg-white p-6 shadow-lg border border-[#e5e7eb]">
            <div className="space-y-4" role="list">
              <div className="flex items-start gap-3" role="listitem">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#4a90e2] text-sm font-medium text-white" aria-label="AI coach avatar">
              ...
              <div className="flex items-start gap-3 justify-end" role="listitem">
      ...
      <section aria-labelledby="problem-heading" className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="grid gap-12 md:grid-cols-2">
            <div className="space-y-4">
              <h2 id="problem-heading" className="text-2xl font-semibold text-[#1a1a1a]">The pain</h2>
              <ul className="space-y-3 text-lg text-[#4b5563]" role="list">
            ...
            <div className="space-y-4">
              <h2 id="insight-heading" className="text-2xl font-semibold text-[#1a1a1a]">The insight</h2>
      ...
      <section id="how-it-works" aria-labelledby="how-it-works-heading" className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <h2 id="how-it-works-heading" className="text-center text-3xl font-semibold text-[#1a1a1a] sm:text-4xl">
            A simple daily coaching loop
          </h2>
          <div className="mt-12 grid gap-8 md:grid-cols-3" role="list">
            {/* Step 1: Check-in */}
            <article className="group rounded-2xl bg-white p-6 shadow-sm border border-[#e5e7eb] transition-shadow hover:shadow-md" role="listitem">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#4a90e2]/10 text-2xl" aria-label="Step 1">
            ...
            {/* Step 2: Reflect */}
            <article className="group rounded-2xl bg-white p-6 shadow-sm border border-[#e5e7eb] transition-shadow hover:shadow-md" role="listitem">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#4a90e2]/10 text-2xl" aria-label="Step 2">
            ...
            {/* Step 3: Nudge */}
            <article className="group rounded-2xl bg-white p-6 shadow-sm border border-[#e5e7eb] transition-shadow hover:shadow-md" role="listitem">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#4a90e2]/10 text-2xl" aria-label="Step 3">
      ...
      <section aria-labelledby="different-heading" className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <h2 id="different-heading" className="text-center text-3xl font-semibold text-[#1a1a1a] sm:text-4xl">
            ...
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  <ul className="space-y-3" role="list">
                    <li className="flex items-start gap-2">
                      <span className="text-[#4a90e2] mt-1" aria-hidden="true">✓</span>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="space-y-3" role="list">
                    <li className="flex items-start gap-2">
                      <span className="text-[#9ca3af] mt-1" aria-hidden="true">•</span>
      ...
      <section aria-labelledby="preview-heading" className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <h2 id="preview-heading" className="text-center text-3xl font-semibold text-[#1a1a1a] sm:text-4xl">
            What it feels like
          </h2>
          <div className="mt-12 space-y-6" role="list">
            {/* Morning clarity */}
            <article className="rounded-2xl bg-white p-6 shadow-sm border border-[#e5e7eb]" role="listitem">
      ...
      <section aria-labelledby="social-proof-heading" className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 space-y-4">
            <blockquote className="text-lg italic text-[#4b5563]">
              ...
              <footer className="sr-only">Early user testimonial</footer>
            </blockquote>
          </div>
        </div>
      </section>
      ...
      {/* Final CTA Section */}
      <section id="waitlist" aria-labelledby="waitlist-heading" className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl rounded-2xl bg-[#f3f4f6] px-8 py-16 text-center">
          <h2 id="waitlist-heading" className="text-3xl font-semibold text-[#1a1a1a] sm:text-4xl">
      ...
      <footer className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl border-t border-[#e5e7eb] pt-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <nav aria-label="Footer navigation" className="flex flex-wrap items-center justify-center gap-6 text-sm text-[#6b7280]">
              <a href="#privacy" className="hover:text-[#1a1a1a] transition-colors focus:outline-none focus:ring-2 focus:ring-[#4a90e2] focus:ring-offset-2 rounded">Privacy</a>
              <a href="#terms" className="hover:text-[#1a1a1a] transition-colors focus:outline-none focus:ring-2 focus:ring-[#4a90e2] focus:ring-offset-2 rounded">Terms</a>
              <a href="#contact" className="hover:text-[#1a1a1a] transition-colors focus:outline-none focus:ring-2 focus:ring-[#4a90e2] focus:ring-offset-2 rounded">Contact</a>
            </nav>
          </div>
        </div>
      </footer>
